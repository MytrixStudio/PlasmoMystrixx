...
public final class ConfigPacket extends ConfigPlayerInfoPacket {
    ...
    @Getter
    private String clientControlYaml = "";
    ...
    public ConfigPacket(
            ...
            @Nullable String clientControlYaml
    ) {
        super(permissions);
        ...
        this.clientControlYaml = clientControlYaml == null ? "" : clientControlYaml;
    }
    ...
    public void read(ByteArrayDataInput in) throws IOException {
        ...
        try {
            this.clientControlYaml = in.readUTF();
        } catch (Exception ignored) {
            this.clientControlYaml = "";
        }
    }
    ...
    public void write(ByteArrayDataOutput out) throws IOException {
        ...
        out.writeUTF(clientControlYaml == null ? "" : clientControlYaml);
    }
