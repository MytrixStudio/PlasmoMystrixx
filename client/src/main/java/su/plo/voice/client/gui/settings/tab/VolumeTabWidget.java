...
public final class VolumeTabWidget extends TabWidget {
    ...
    public void init() {
        ...
        if (parent.isControlVisible("volume.sources")) {
    ...
    private void createSourceLineVolume(@NotNull ClientSourceLine sourceLine) {
        String sourceControl = "volume.source." + sourceLine.getName();
        if (!parent.isControlVisible(sourceControl, "volume.sources")) return;
        ...
        addControlledEntry(new SourceLineVolumeEntry<>(
    ...
    private void createPlayersSearch() {
        ...
        addControlledEntry(entry, "volume.search");
    ...
    private void refreshPlayerEntries() {
        if (!parent.isControlVisible("volume.players")) return;
    ...
    private void createPlayerVolume(@NotNull McGameProfile player) {
        ...
        addControlledEntry(new PlayerVolumeEntry<>(
                createVolumeSlider(volumeEntry),
                createMuteButton(buttons, updateButtons, muteEntry),
                volumeEntry,
                muteEntry,
