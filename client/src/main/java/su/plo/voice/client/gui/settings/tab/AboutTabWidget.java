...
public final class AboutTabWidget extends TabWidget {
    ...
    private McTextComponent madeBy() {
        McTextComponent madeBy = McTextComponent.translatable("gui.plasmovoice.about.made_by", "Mytrix Voice");
        if (!LanguageUtil.getOrDefault("gui.plasmovoice.about.made_by").contains("%s")) {
            madeBy = McTextComponent.literal("Mytrix Voice is made by");
        }
    ...
    private McTextComponent links() {
        McTextComponent links = McTextComponent.translatable("gui.plasmovoice.about.links", "Mytrix Voice");
        if (!LanguageUtil.getOrDefault("gui.plasmovoice.about.links").contains("%s")) {
            links = McTextComponent.literal("Mytrix Voice on");
        }
