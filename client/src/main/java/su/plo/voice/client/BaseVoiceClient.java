...
import su.plo.voice.client.render.voice.SpeakingHeadsHudRenderer;
...
public abstract class BaseVoiceClient extends BaseVoice implements PlasmoVoiceClient {
    ...
    @Getter
    @Setter
    protected ClientControlConfig clientControlConfig = ClientControlConfig.defaults();
    @Getter
    ...
    protected void onInitialize() {
        ...
        HudRenderEvent.INSTANCE.registerListener(new SpeakingHeadsHudRenderer(this, config));
    ...
    protected void onServerDisconnect() {
        ...
        this.clientControlConfig = ClientControlConfig.defaults();
