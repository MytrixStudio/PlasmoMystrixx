...
public final class DevicesTabWidget extends TabWidget {
    ...
    public void init() {
        ...
        if (isAnyControlVisible(
                "devices.activation_threshold",
                "devices.microphone",
                "devices.microphone_volume",
                "devices.noise_suppression",
                "devices.stereo_capture",
                "devices.disable_input_device"
        )) {
            addEntry(new CategoryEntry(McTextComponent.translatable("gui.plasmovoice.devices.microphone")));
        }
        addControlledEntry(createThresholdEntry(), "devices.activation_threshold");
        addControlledEntry(createMicrophoneEntry(), "devices.microphone");
        addControlledEntry(createVolumeSlider(
        ...
        addControlledEntry(createStereoCaptureEntry(), "devices.stereo_capture");
        addControlledEntry(createToggleEntry(
        ...
        if (isAnyControlVisible(
                ...
                "devices.output_volume",
                "devices.sound_occlusion",
                "devices.directional_sources",
                "devices.hrtf"
        )) {
            addEntry(new CategoryEntry(McTextComponent.translatable("gui.plasmovoice.devices.output")));
        }
        addControlledEntry(createOutputDeviceEntry(), "devices.output_device");
        addControlledEntry(createVolumeSlider(
...
//        ));
        ...
        addControlledEntry(createHrtfEntry(), "devices.hrtf");
    }
